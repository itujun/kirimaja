...
export const ADDRESS_PHOTO_UPLOAD_DIR = join(
    process.cwd(),
    'public',
    'uploads',
    'address-photos',
...
export const ALLOWED_ADDRESS_PHOTO_MIME_TYPES = [
    'image/jpeg',
    'image/jpg',
    'image/png',
    'image/gif',
